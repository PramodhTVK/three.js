...
const CanvasModel = () => {
  return (
    <Canvas>   {/* Canvas is a component from @react-three/fiber.It is a wrapper provided by react-three-fiber that sets up a WebGL Canvas ans creates a 3D Rendering Context */}
